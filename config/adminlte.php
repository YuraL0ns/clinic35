...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Услуги и разделы',
            'icon' => 'fas fa-fw fa-magnet',
            'submenu' => [
                [
                    'text' => 'Разделы',
                    'icon' => 'fas fa-stream',
        ...
        'Summernote' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.20/summernote-bs5.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.20/summernote-bs5.min.css',
                ],
            ],
        ],
        'Select2' => [
